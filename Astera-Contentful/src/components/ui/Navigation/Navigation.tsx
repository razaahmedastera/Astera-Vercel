...
export function Header({ products, industries = [] }: HeaderProps) {
  ...
  const isResourceActive = pathname === '/blog' || pathname?.startsWith('/type/blog/') || pathname === '/datasheets' || pathname?.startsWith('/data-sheet/') || pathname === '/e-books' || pathname?.startsWith('/type/e-book/') || pathname === '/videos' || pathname === '/webinars' || pathname?.startsWith('/type/webinars/') || pathname === '/resources/whitepapers' || pathname?.startsWith('/type/whitepaper/');
  ...
  const resourceLinks = [
    ...
    { href: '/datasheets', label: 'Data Sheets', active: pathname === '/datasheets' || pathname?.startsWith('/data-sheet/') },
