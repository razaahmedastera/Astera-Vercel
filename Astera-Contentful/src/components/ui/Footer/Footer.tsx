      ...
      <div className="section-container grid grid-cols-1 lg:grid-cols-[1.5fr_2fr] gap-16 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/technology-partners" className="text-slate-400 text-sm no-underline transition-colors hover:text-white">Tech Partners</Link>
          </div>
          <div className="flex flex-col gap-3">
            <h4 className="text-base font-semibold text-white m-0 mb-2">Customers</h4>
            <Link href="/customers/case-studies" className="text-slate-400 text-sm no-underline transition-colors hover:text-white">Case Studies</Link>
            <Link href="/customers/user-reviews" className="text-slate-400 text-sm no-underline transition-colors hover:text-white">User Reviews</Link>
